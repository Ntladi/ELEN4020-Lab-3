...
python3 ./Scripts/run_inverted_index.py ./Input/large.txt ./Output/large.txt 20
printf "\n\nRunning Inverted Index for Very Large Inputs\n\n"
python3 ./Scripts/run_inverted_index.py ./Input/very_large.txt ./Output/very_large.txt 10
