...
python3 ./Scripts/run_inverted_index.py ./Input/small.txt ./Output/small.txt 20 50
printf "\n\nRunning Inverted Index for the Large Input\n\n"
python3 ./Scripts/run_inverted_index.py ./Input/large.txt ./Output/large.txt 20 50
